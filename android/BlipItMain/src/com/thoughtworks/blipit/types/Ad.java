...
public class Ad implements Serializable {
    ...
    public Ad(Key key, String title, String description, Location geoPoint, String creatorId, Set<Key> channelKeys) {
        this.key = key;
        this.title = title;
    ...
    public void setCreatorId(String deviceId, String phoneNumber) {
        this.creatorId = String.format(BlipItUtils.CREATOR_ID, deviceId, phoneNumber);
    }
